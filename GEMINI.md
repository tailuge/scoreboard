...
yarn coverage  # Run Jest tests with coverage report
yarn e2e       # Run Playwright E2E tests
```

### Docker
- `yarn docker:build`: Builds the Nchan Docker image.
- `yarn docker:push`: Pushes the Nchan image to the registry.
