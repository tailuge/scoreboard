  ...
  return (
    <>
      <button
        ...
        className="bg-transparent border-none p-0 appearance-none text-inherit font-inherit cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 rounded-sm block"
