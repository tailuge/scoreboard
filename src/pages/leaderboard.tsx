  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4 md:p-8 font-sans text-gray-100">
      <Seo
        ...
        description="Check the latest rankings and high scores for free open source Snooker, 8-Ball, 9-Ball, and Three-Cushion billiards. ビリヤードのリーダーボード、スヌーカー、8ボール、9ボール、3クッション。 당구 순위표, 스누커, 8볼, 9볼, 3쿠션."
        keywords="billiards, leaderboard, rankings, snooker, 8-ball, 9-ball, eightball, nineball, carom, three-cushion, ビリヤード, リーダーボード, ランキング, スヌーカー, 8ボール, 9ボール, 3クッション, 당구, 순위표, 랭킹, 스누커, 8볼, 9볼, 3쿠션"
