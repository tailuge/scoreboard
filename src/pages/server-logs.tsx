        ...
        <div className="container mx-auto p-4">
            ...
            <div className="grid gap-2">
                {error ? (
                    ...
                    <p className="text-gray-500 italic">No active tables found.</p>
                ) : (
                    tables.map((table) => (
                        <div key={table.id} className="border rounded-lg shadow-sm overflow-hidden">
                            <button
                            ...
                            >
                                <div className="flex-grow">
                                    ...
                                    <span className="ml-4 font-semibold">Creator:</span> {table.creator.name}
                                </div>
