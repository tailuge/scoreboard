...
Current error handling logs to the console but doesn't inform the user.
- **Action:** Implement a toast or notification system to show errors when joining or creating a table fails.
