    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://va.vercel-scripts.com https://cdn.jsdelivr.net https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://*.onrender.com wss://*.onrender.com https://cdn.jsdelivr.net https://vercel.live; frame-src 'self' https://tailuge.github.io https://billiards.tailuge.workers.dev https://vercel.live; frame-ancestors *; object-src 'none'; upgrade-insecure-requests;",
          },
          {
